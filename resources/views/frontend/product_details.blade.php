            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="product-single-img">
                        ...
                        <div class="item">
                        <img src="{{asset('uploads/product_thumbnails')}}/{{$product_info->product_thumbnail_photo}}" alt="">
                            </div>

                            @foreach($product_info->get_multiple_photos as $multiple_photo)
                            <div class="item">
                        <img src="{{asset('uploads/product_multiple_photos')}}/{{$multiple_photo->multiple_photo_name}}" alt="">
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="featured-product-wrap">
                        <div class="featured-product-img">
                            <img src="{{asset('uploads/product_thumbnails')}}/{{$related_product->product_thumbnail_photo}}" alt="">
                        </div>
